    ...
    extraSections: [
      {
        ...
        paragraphs: [
          'Базовые сценарии (регистрация, профиль, первый пост) — 15–30 минут. Запуск простого сообщества с чатом и объявлениями — от нескольких часов до одного дня, если контент уже готов.',
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          'После регистрации у вас появляется публичная страница с именем, аватаром, описанием и счётчиками подписок. Её можно отправлять как визитку в Telegram, Twitter или email-рассылке.',
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          'Telegram, Twitter, YouTube, email — везде одна и та же ссылка на сообщество. Просите ядро аудитории репостить лучшие посты.',
        ],
      },
    ],
  },
