...
export const activityPage = {
  shell: 'min-h-0 flex h-full w-full bg-gradient-to-b from-slate-50 via-white to-slate-100/80',
  ...
  cardHover: 'transition-shadow hover:shadow-md hover:shadow-slate-200/50',
