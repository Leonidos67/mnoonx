...
function disposeThreeInstance(t: {
  resizeObserver?: ResizeObserver;
  raf: number;
  quad?: { geometry: { dispose: () => void } };
  material: { dispose: () => void };
  composer?: { dispose: () => void };
  renderer: THREE.WebGLRenderer & { domElement: HTMLCanvasElement; forceContextLoss: () => void };
}) {
...
const PixelBlast = ({
  ...
  useEffect(() => {
    ...
    if (!container || !canUseWebGL2()) return;
    ...
    const initFrame = requestAnimationFrame(runInit);
