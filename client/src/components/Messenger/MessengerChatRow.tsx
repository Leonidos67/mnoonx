...
const MessengerChatRow: React.FC<MessengerChatRowProps> = ({
  ...
  <div className={`flex w-full items-start gap-3 p-4 text-left ${className}`}>
    ...
    <div className="min-w-0 flex-1">
      <div className="flex items-baseline justify-between gap-2">
        ...
        <span className="shrink-0 text-xs text-neutral-400">{formatListTime(chat.lastMessageTime)}</span>
      </div>
      <p
