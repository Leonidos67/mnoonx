  ...
  const list: ChatActionRow[] = [
    {
      ...
      icon: isPinned ? (
        <PinOff className="h-4 w-4 text-neutral-700" aria-hidden />
      ) : (
        <Pin className="h-4 w-4 text-neutral-700" aria-hidden />
      ),
    },
    {
      id: 'markNew',
      label: labels.markNew,
      icon: <Sparkles className="h-4 w-4 text-neutral-700" aria-hidden />,
    },
    {
      id: 'report',
      label: labels.report,
      icon: <Flag className="h-4 w-4 text-neutral-700" aria-hidden />,
    },
    {
      id: 'delete',
      label: labels.deleteChat,
      icon: <Trash2 className="h-4 w-4 text-red-600" aria-hidden />,
      destructive: true,
    },
  ];
  if (isDm) {
    list.splice(3, 0, {
      ...
      icon: <Ban className="h-4 w-4 text-neutral-700" aria-hidden />,
    });
  }
  return list;
}
